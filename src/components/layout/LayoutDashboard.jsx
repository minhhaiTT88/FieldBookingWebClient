...
import bg from "../../assets/image/nen.jpg";

const LayoutDashboard = (props) => {
  return (
    <div
      className="app overflow-y-auto"
      style={{
    ...
    >
      ...
      <footer>
        <div className="p-10">
          <div className="section-form-bottom">
            <div className="info">
              <h3 className="title-section text-center">
                Bạn cần tư vấn xây dựng, bảo trì sân thi đấu <br />
                hãy để lại thông tin
              </h3>
              <div className="element-form">
                <form
                  nh-form-contact="NTO3EF6DQA"
                ...
                >
                  <div className="form-group mb-0">
                    ...
                    <input
                      ...
                      id="link"
                      type="hidden"
                      defaultValue="/san-bong-da-plf-s1c1d276w10000"
                      className="form-control"
                    />
                    <input
                      name="redirect"
                      type="hidden"
                      defaultValue="NTO3EF6DQA"
                      className="form-control"
                    />
                    <span nh-btn-action="submit" className="btn btn-submit">
                      Gửi
                    </span>
                  </div>
                </form>
              ...
              <img
                ...
                className="img-fluid"
                alt="banner"
                src="https://img.thegioithethao.vn/media/danh-muc/bong-da.png"
                style={{}}
              />
            </div>
          </div>
        ...
        <div className="py-5">
          <div className="copyright text-center text-white">
            Copyright © 2024 DangMinhHai. All rights reserved.
          </div>
        </div>
      </footer>
    </div>
